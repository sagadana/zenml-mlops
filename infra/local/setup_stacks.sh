...
ARTIFACT_STORE_ENDPOINT_URL_RAW="${ZENML_ARTIFACT_STORE_ENDPOINT_URL:-${SEAWEEDFS_S3_ENDPOINT_URL:-http://localtest.me:8333}}"
...
echo "  ✓ Artifact store: ${ZENML_LOCAL_ARTIFACT_STORE_NAME} (path=${ARTIFACT_STORE_PATH})"
