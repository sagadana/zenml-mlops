...
Collects recent inference request logs from S3 access logs or a structured
log file written by the FastAPI serving app.
"""
...
def collect_inference_logs(
    ...
    Expected log format (JSON lines written by serving/app.py):
