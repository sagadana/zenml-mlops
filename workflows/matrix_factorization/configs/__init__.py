...
CFG_ONLINE_EVALUATION_PIPELINE_NAME = "matrix_factorization_online_evaluation"
CFG_ONLINE_EVALUATION_PIPELINE_SNAPSHOT_NAME = "matrix_factorization_online_evaluation_snapshot"
